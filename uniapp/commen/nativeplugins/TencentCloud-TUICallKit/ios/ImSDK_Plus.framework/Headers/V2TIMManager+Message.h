...
@property(nonatomic,strong) NSString * iOSInterruptionLevel;
...
@property(nonatomic,strong) NSString *AndroidOPPOCategory;
...
@property(nonatomic,strong) NSString *AndroidHonorImportance;
